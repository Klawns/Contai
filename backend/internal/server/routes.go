...
func registerRoutes(router *gin.Engine, dependencies dependencies) {
	...
	authenticated.GET("/payables", dependencies.commitmentHandler.ListPayables)
	authenticated.POST("/payables", limitBody(authBodyLimitBytes), dependencies.commitmentHandler.CreatePayable)
	authenticated.PATCH("/payables/:id", limitBody(authBodyLimitBytes), dependencies.commitmentHandler.UpdatePayable)
	authenticated.PATCH("/payables/:id/pay", limitBody(authBodyLimitBytes), dependencies.commitmentHandler.PayPayable)
	authenticated.PATCH("/payables/:id/cancel", dependencies.commitmentHandler.CancelPayable)
	authenticated.GET("/receivables", dependencies.commitmentHandler.ListReceivables)
	authenticated.POST("/receivables", limitBody(authBodyLimitBytes), dependencies.commitmentHandler.CreateReceivable)
	authenticated.PATCH("/receivables/:id", limitBody(authBodyLimitBytes), dependencies.commitmentHandler.UpdateReceivable)
	authenticated.PATCH("/receivables/:id/receive", limitBody(authBodyLimitBytes), dependencies.commitmentHandler.ReceiveReceivable)
	authenticated.PATCH("/receivables/:id/cancel", dependencies.commitmentHandler.CancelReceivable)
