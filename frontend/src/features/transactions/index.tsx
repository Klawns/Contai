...
export function TransactionListPage() {
  ...
  return (
    <TransactionsPageLayout animationKey={formatMonthQuery(selectedMonth)}>
      <section className="mx-auto flex min-h-svh w-full max-w-[520px] flex-col bg-[#6818e8] text-left shadow-[0_24px_70px_rgba(43,35,54,0.12)] md:max-w-[720px]">
  ...
  if (!transactionId) {
    return (
      <TransactionsPageLayout variant="create" tone="expense" animationKey="edit-missing">
        <section className="mx-auto flex min-h-svh w-full max-w-[520px] flex-col bg-white px-5 py-[calc(28px+env(safe-area-inset-top))] text-left shadow-[0_24px_70px_rgba(43,35,54,0.12)] md:max-w-[640px] md:px-8">
          <button
            type="button"
