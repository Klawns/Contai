...
export function MonthSelector({
  ...
  return (
    <div ref={containerRef} className="relative inline-flex min-w-0 items-center justify-center">
      <motion.button
        type="button"
        className="inline-flex h-9 min-w-0 cursor-pointer items-center justify-center gap-1 bg-transparent px-1 text-[15px] font-medium leading-none text-[#8d8495] transition-colors hover:text-[#5f566b] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#7b2cff]"
      ...
      >
        <span className="truncate text-[#5f566b]">{selectedMonthLabel}</span>
        <ChevronDown
